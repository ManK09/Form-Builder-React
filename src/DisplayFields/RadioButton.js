...
import { Radio,Checkbox, Button, Modal, Form, Input } from 'antd';
...
const RadioButton = ({type,label,placeholder,helpertext,options,id}) => {
...
const handleAddFields = () => {
    ...
    return(
        <div style={{...opacity}}>
            ...
            return(
                <div>
                <Radio style={{float:"left"}}>{x.value}</Radio>
                <br />
                </div>
            )
            })}
