...
import { TimePicker, Form, Button, Modal,Input} from 'antd';
...
const Time = ({type,label,placeholder,helpertext,options,id}) =>{
        ...
        <div style={{...opacity}}>
            ...
            >
                <Form.Item>
                    ...
                    <br />
                    <TimePicker defaultOpenValue={moment('00:00:00', 'HH:mm:ss')} style={{backgroundColor:"#5d8d97"}}/>
                    <br />
